...
/**
 * Pairs an in-app Notification with a queued email for team-hierarchy
 * notification flows (e.g. notifying a team's leaders about an action taken
 * by one of their members). Ensures every caller sends the same
 * "notification row + email" pair the same way, through the Notification /
 * NotificationService API rather than ad-hoc inserts.
 */
class TeamNotifier
{
    /**
